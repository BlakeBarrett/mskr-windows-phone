...
namespace mskr
{
    public partial class AboutPage : PhoneApplicationPage
    {
        ...
        private static String ABOUT_MSKR = "mskr lets you layer shape masks over images and save them. Small app making small claims. If you don't like it, use Photoshop. \nmskr was written by Blake Barrett with design support from Tiffany Taylor. \nMore info can be found at http://mskr.co";
